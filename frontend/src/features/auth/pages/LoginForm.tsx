      ...
      if (response.data) {
        ...
        if (response != null && response.success === true) {//* Success
          ...
          if (response.data.errorType === "email") {
            ...
            setPasswordError(localize('loginPasswordWrong'));
            setEmailError("");
          } else {
            setPasswordError(localize('unknownError'));
            setEmailError("");
          }
        }
      }
      ...
      <div className="flex justify-end p-4">
        ...
        >
          {darkMode ? (
            ...
            <svg className="w-6 h-6 text-main-white dark:text-main-black" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
      ...
      <div className="flex items-center justify-center flex-1">
        <div className="w-full max-w-md">
          ...
          <p className="text-center text-gray-500 text-xs">
            &copy;2020 Y. Emre Demirci. Tüm hakları saklıdır.
          </p>
        </div>
      </div>
    </div>
